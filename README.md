...
Datasets and corresponding metadata can be found in [Google Drive](https://drive.google.com/file/d/1zQMKkAe9MS4rcYx-_0kLNOIlDPiD7YCT/view?usp=drive_link). Simply download them and specify necessary paths in the `.yaml` configurations.ß